...
- $data/fracture_{\mathrm{colloid}}_{\mathrm{parameter}}_{\mathrm{sources}}.csv$：资料源—参数用途表。
- $data/fracture_{\mathrm{colloid}}_{\mathrm{nuclide}}_{\mathrm{parameters}}.csv$：核素分组、代表性 Kd、胶体结合系数和迁移指标。
- $data/fracture_{\mathrm{colloid}}_{\mathrm{screening}}_{\mathrm{results}}.csv$：所有公式计算结果。
...
<svg id="geomine-mermaid-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1354 360" role="img" aria-label="Mermaid flowchart">
  <defs>
  ...
  <rect x="1" y="1" width="1352" height="358" rx="10" fill="#ffffff" stroke="#edf3f5"/>
  <path d="M 210.0 264.0 C 397.0 264.0, 397.0 180.0, 577.0 180.0" class="gm-edge"/>
<path d="M 734.0 180.0 C 939.0 180.0, 939.0 266.0, 1137.0 266.0" class="gm-edge"/><rect x="865.0" y="204.0" width="148" height="20" rx="4" class="gm-edge-label-bg"/><text x="939.0" y="218.0" text-anchor="middle" class="gm-edge-label">advection + dispersion</text>
<path d="M 734.0 180.0 C 939.0 180.0, 939.0 94.0, 1137.0 94.0" class="gm-edge"/><rect x="883.0" y="118.0" width="112" height="20" rx="4" class="gm-edge-label-bg"/><text x="939.0" y="132.0" text-anchor="middle" class="gm-edge-label">matrix diffusion</text>
<path d="M 1294.0 94.0 C 939.0 94.0, 939.0 180.0, 577.0 180.0" class="gm-edge"/><rect x="880.0" y="118.0" width="118" height="20" rx="4" class="gm-edge-label-bg"/><text x="939.0" y="132.0" text-anchor="middle" class="gm-edge-label">diffusive release</text>
<path d="M 1326.0 180.0 C 1078.0 180.0, 1078.0 222.0, 823.0 222.0" class="gm-edge"/><rect x="1031.0" y="182.0" width="94" height="20" rx="4" class="gm-edge-label-bg"/><text x="1078.0" y="196.0" text-anchor="middle" class="gm-edge-label">surface sites</text>
<path d="M 734.0 180.0 C 782.0 180.0, 782.0 222.0, 823.0 222.0" class="gm-edge"/>
<path d="M 1016.0 222.0 C 1080.0 222.0, 1080.0 94.0, 1137.0 94.0" class="gm-edge"/>
<path d="M 242.0 180.0 C 290.0 180.0, 290.0 180.0, 331.0 180.0" class="gm-edge"/>
<path d="M 488.0 180.0 C 536.0 180.0, 536.0 180.0, 577.0 180.0" class="gm-edge"/>
<path d="M 242.0 96.0 C 545.0 96.0, 545.0 138.0, 841.0 138.0" class="gm-edge"/>
<path d="M 734.0 180.0 C 791.0 180.0, 791.0 138.0, 841.0 138.0" class="gm-edge"/>
<path d="M 998.0 138.0 C 1055.0 138.0, 1055.0 180.0, 1105.0 180.0" class="gm-edge"/><rect x="984.0" y="140.0" width="142" height="20" rx="4" class="gm-edge-label-bg"/><text x="1055.0" y="154.0" text-anchor="middle" class="gm-edge-label">filtration/attachment</text>
<path d="M 998.0 138.0 C 1071.0 138.0, 1071.0 266.0, 1137.0 266.0" class="gm-edge"/><rect x="1000.0" y="183.0" width="142" height="20" rx="4" class="gm-edge-label-bg"/><text x="1071.0" y="197.0" text-anchor="middle" class="gm-edge-label">facilitated transport</text>
  <g class="gm-node-group" data-node-id="Source">
    <rect x="60" y="236" width="150" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="135.0" y="264.0">核素源项</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Fracture">
    <rect x="584" y="152" width="150" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="659.0" y="180.0">流动裂隙水</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Outlet">
    <rect x="1144" y="238" width="150" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="1219.0" y="266.0">远场通量</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Matrix">
    <rect x="1144" y="66" width="150" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="1219.0" y="94.0">岩石基质孔隙</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Minerals">
    <rect x="1112" y="150" width="214" height="60" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="1219.0" y="171.0">黑云母/绿泥石/Fe-Mn氧化物/</tspan>
<tspan x="1219.0" y="189.0">方解石/黏土</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Sorption">
    <rect x="830" y="194" width="186" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="923.0" y="222.0">吸附/表面络合/离子交换</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Redox">
    <rect x="28" y="152" width="214" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="135.0" y="180.0">pH/Eh/碳酸盐/硫酸盐/氯离子</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Speciation">
    <rect x="338" y="152" width="150" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="413.0" y="180.0">价态与络合形态</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Colloids">
    <rect x="28" y="68" width="214" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="135.0" y="96.0">黏土/Fe-Mn/有机/微生物胶体</tspan></text>
  </g>
<g class="gm-node-group" data-node-id="Carrier">
    <rect x="848" y="110" width="150" height="56" rx="8" class="gm-node"/>
    <text text-anchor="middle" class="gm-node-text"><tspan x="923.0" y="138.0">移动载体</tspan></text>
  </g>
</svg>
